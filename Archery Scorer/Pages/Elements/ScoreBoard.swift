                    ...
                    VStack {
                        ForEach(0..<6, id: \.self) { i in
                            HStack {
                                ...
                                ScoreBoardSecondView(scoreData: $scoreData, selectedBox: $selectedBox ,i: .constant(i), selectedRowButton: $selectedRowButton, buttonSize: .constant(gr.size.width * 0.15))
